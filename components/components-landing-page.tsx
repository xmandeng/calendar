    ...
    <div className="flex flex-col min-h-screen bg-[#EDE8F5] text-[#3D52A0]">
      ...
      <main className="flex-1">
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <div className="space-x-4">
                ...
                <Link href="#features">
                  <Button 
                    variant="outline" 
                    className="text-[#3D52A0] border-[#3D52A0] hover:bg-[#3D52A0] hover:text-[#EDE8F5]"
                  >
                    Learn More
                  </Button>
                </Link>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-10 sm:grid-cols-2 max-w-4xl mx-auto">
              ...
              <div className="flex flex-col items-center space-y-3 text-center">
                ...
                <h3 className="text-xl font-bold text-[#3D52A0]">ICS Format</h3>
                <p className="text-sm text-[#8697C4]">Download or host your calendar in ICS format</p>
              </div>
              <div className="flex flex-col items-center space-y-3 text-center">
                <div className="bg-[#ADBDDA] p-3 rounded-full">
                  <CreditCard className="h-8 w-8 text-[#3D52A0]" />
                </div>
                <h3 className="text-xl font-bold text-[#3D52A0]">Flexible Pricing</h3>
                <p className="text-sm text-[#8697C4]">Pay per download or subscribe for hosting</p>
              </div>
            </div>
          </div>
        </section>
        <section id="pricing" className="w-full py-12 md:py-24 lg:py-32 bg-[#ADBDDA]">
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-center mb-12 text-[#3D52A0]">Pricing</h2>
            <div className="grid gap-10 sm:grid-cols-2 max-w-4xl mx-auto">
              <div className="flex flex-col p-6 bg-[#EDE8F5] rounded-lg shadow-lg">
                <h3 className="text-2xl font-bold text-[#3D52A0] mb-4">Basic</h3>
                <p className="text-4xl font-bold text-[#3D52A0] mb-6">$9.99<span className="text-lg font-normal">/month</span></p>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-center">
                    ...
                    <span className="ml-2 text-[#3D52A0]">Up to 100 events per month</span>
                  </li>
                  <li className="flex items-center">
                    <svg
                      className="text-[#7091E6] flex-shrink-0 h-6 w-6"
                    ...
                    <span className="ml-2 text-[#3D52A0]">Host up to 5 calendars</span>
                  </li>
                </ul>
                <Button className="w-full bg-[#7091E6] text-[#EDE8F5] hover:bg-[#3D52A0]">Subscribe Now</Button>
              </div>
              <div className="flex flex-col p-6 bg-[#EDE8F5] rounded-lg shadow-lg">
                <h3 className="text-2xl font-bold text-[#3D52A0] mb-4">Pro</h3>
                <p className="text-4xl font-bold text-[#3D52A0] mb-6">$19.99<span className="text-lg font-normal">/month</span></p>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-center">
                    <svg
                      className="text-[#7091E6] flex-shrink-0 h-6 w-6"
                    ...
                    <span className="ml-2 text-[#3D52A0]">Unlimited events</span>
                  </li>
                  <li className="flex items-center">
                    <svg
                      className="text-[#7091E6] flex-shrink-0 h-6 w-6"
